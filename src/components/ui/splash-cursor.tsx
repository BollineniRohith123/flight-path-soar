...
function SplashCursor({
  ...
  useEffect(() => {
    ...
    function getWebGLContext(canvas: HTMLCanvasElement) {
      ...
      const isWebGL2 = !!gl && 'beginQuery' in gl;
      if (!isWebGL2)
        gl =
    ...
    function clickSplat(pointer: any) {
      ...
      // Boost intensity for click splashes (brand colors will still be used)
      color.r *= 12.0;
      color.g *= 12.0;
      color.b *= 12.0;
    ...
    function generateColor() {
      // Use only brand colors: Deep Sky Blue (209, 100%, 40-60%) and Metallic Gold (51, 100%, 50-60%)
      const brandColors = [
        // Deep Sky Blue variations
        { r: 0.0, g: 0.478, b: 0.8 },      // hsl(209, 100%, 40%) - Primary
        { r: 0.2, g: 0.6, b: 1.0 },        // hsl(209, 100%, 60%) - Primary Light
        { r: 0.0, g: 0.359, b: 0.6 },      // hsl(209, 100%, 30%) - Primary Dark
        // Metallic Gold variations
        { r: 1.0, g: 0.843, b: 0.0 },      // hsl(51, 100%, 50%) - Accent
        { r: 1.0, g: 0.922, b: 0.4 },      // hsl(51, 100%, 60%) - Accent Light
        { r: 0.8, g: 0.722, b: 0.0 },      // hsl(45, 100%, 45%) - Gold Dark
      ];
